<?php
    ...
    if(isset($busca) && $busca!=""){
        $consulta_dados="SELECT * FROM apostas WHERE (team_home LIKE '%$busca%' OR team_away LIKE '%$busca%') AND status is not null ORDER BY data ASC,league LIMIT $inicio,$registros";

        $consulta_total="SELECT count(id) FROM apostas WHERE (team_home LIKE '%$busca%' OR team_away LIKE '%$busca%') AND status is not null";
    }else{
        $consulta_dados="SELECT * FROM apostas WHERE status is not null ORDER BY data ASC,league LIMIT $inicio,$registros";

        $consulta_total="SELECT count(id) FROM apostas WHERE status is not null";
    }
