<?php
    ...
    if(isset($busca) && $busca!=""){
        $consulta_dados="SELECT * FROM prog WHERE (eq_casa LIKE '%$busca%' OR eq_fora LIKE '%$busca%') ORDER BY data DESC,league LIMIT $inicio,$registros";

        $consulta_total="SELECT count(id) FROM prog WHERE (eq_casa LIKE '%$busca%' OR eq_fora LIKE '%$busca%')";
    }else{
        $consulta_dados="SELECT * FROM prog ORDER BY data DESC,league LIMIT $inicio,$registros";

        $consulta_total="SELECT count(id) FROM prog";
    }
