...
<div class="container pb-6 pt-6">
	...
	<form action="./php/bet.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<input type="hidden" value="OVER FT" name="mercado" required >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Método</label>
				  	<input class="input" type="text" name="metodo" value="Over 2,5" pattern="[a-zA-Z0-9]{4,20}" readonly="readonly" >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
		...
		<div class="columns">
		  	<div class="column">
				...
				<input type="hidden" value="Over 2,5 FT" name="entrada" required >
				<br>
