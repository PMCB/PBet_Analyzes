...
<div class="container pb-6 pt-6">
	...
	<form action="./php/bet.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<input type="hidden" value="BTTS" name="mercado" required >				
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Método</label>
				  	<input class="input" type="text" name="metodo" pattern="[a-zA-Z0-9]{4,20}">
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Entrada</label>
                    <input class="input" type="text" name="entrada" pattern="[a-zA-Z0-9]{4,20}">
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
