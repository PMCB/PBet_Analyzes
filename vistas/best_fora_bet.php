...
<div class="container pb-6 pt-6">
	...
	<form action="./php/bet.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<input type="hidden" value="1X2" name="mercado" required >
		<input type="hidden" value="Fora" name="entrada" required >				
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Método</label>
				  	<input class="input" type="text" name="metodo" value="Best Fora" pattern="[a-zA-Z0-9]{4,20}" readonly="readonly" >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
